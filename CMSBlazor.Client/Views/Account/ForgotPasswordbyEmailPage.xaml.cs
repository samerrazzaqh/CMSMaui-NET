...
public partial class ForgotPasswordbyEmailPage : ContentPage
{
    public SendTokenEmail SendTokenEmail = new SendTokenEmail();
    AccountService accountService = new AccountService();
    public ForgotPasswordbyEmailPage()
	{
		InitializeComponent();
	}
    ...
    async void btnSubmit_Clicked(System.Object sender, System.EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    await Shell.Current.GoToAsync($"{nameof(PasswordConfirmEmailPage)}?email={SendTokenEmail.Email}", true);
                }
                else
                {
